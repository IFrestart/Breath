...
int CCommFunction::ConsultProcess(SOCKS5_SOCKET sock,const char* pSendBuf, int nSendLen,char *pRecvBuf, int* pRecvLen, int nTimeOut)
{
	int nRetCode = 0;
	int nCount = 0;
...
int CCommFunction::Bind(SOCKS5_SOCKET sock,const char * lpLocalHost, unsigned short nLocalPort)
{
...
int CCommFunction::Bind(SOCKS5_SOCKET sock,unsigned long wLocalHost, unsigned short nLocalPort)
{
	struct sockaddr_in  saLocalAddr;
