...
SOCKS5_SOCKET CTcpSocks5::Create(LPCTSTR lpLocalHost, USHORT nLocalPort, 
	LPCTSTR lpRemoteHost, USHORT nRemotePort, LPCTSTR lpProxyHost, 
	USHORT nProxyPort, LPCTSTR lpProxyUserName, LPCTSTR lpProxyPassword, int type)
{
	...
	if (m_pSocket->Create(SOCK_STREAM, lpLocalHost, nLocalPort) == INVALID_SOCKET)
	{
		delete m_pSocket;
		m_pSocket = NULL;
	}
	...
	if(ConnectTcpProxyServer(lpRemoteHost, nRemotePort, lpProxyHost, nProxyPort,
		lpProxyUserName, lpProxyPassword, 2000, &nErrCode, type) == INVALID_SOCKS5)
	{
		Close();
		return m_hSocket;
	}
...
SOCKS5_SOCKET CTcpSocks5::Create(ULONG lLocalHost, USHORT nLocalPort, ULONG lRemoteHost,
	USHORT nRemotePort, ULONG lProxyHost, USHORT nProxyPort, LPCTSTR lpProxyUserName, 
	LPCTSTR lpProxyPassword, int type)
{
