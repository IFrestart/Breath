...
public:
	int InitializeSession(IACDataCallBack* lpDataCallBack, IACPackHead* lpHeadProc, 
		LPCTSTR lpLocalHost = NULL, USHORT nLocalPort = 0);

	int InitializeSession(IACDataCallBack* lpDataCallBack, IACPackHead* lpHeadProc, LPCTSTR lpLocalHost, USHORT nLocalPort, 
