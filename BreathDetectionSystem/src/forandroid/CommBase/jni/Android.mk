...
LOCAL_SRC_FILES := ThreadCallBack.cpp Thread.cpp Timer.cpp TimerEventCallBack.cpp ACSocket.cpp LogTrace.cpp Tools.cpp SockStream.cpp IdDef.cpp Mutex.cpp\
ACBaseMainProcClass.cpp ACTCPSession.cpp ACUDPSession.cpp ACBaseSession.cpp ACTCPClientProc.cpp ACTCPSessionManager.cpp ACCommMainObject.cpp\
ACTCPMainProcClass.cpp  ACUDPMainProcClass.cpp TCPConnector.cpp TCPAcceptor.cpp UDPConnector.cpp PacketTimeOut.cpp\
