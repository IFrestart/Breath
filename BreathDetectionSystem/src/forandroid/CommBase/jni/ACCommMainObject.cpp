...
{
	printf("nCommType =[%d] nProtocolType=[%d] lpDataCallBack=[%x] \n",nCommType,nProtocolType,lpDataCallBack);
...
void CACMainObject::InitHttp(ISockEventCallBack * lpDataCallBack, ISockHeaderCallBack* lpHeadProc)
{
	assert(lpDataCallBack != NULL);
